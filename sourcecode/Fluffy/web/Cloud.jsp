    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="Cloud.jsp"><span>Cloud Server</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="article" align="center">
          ...
          <br>
          <br>
          <h2 style="color: white"><span>Cloud Login</span></h2>
          <div class="clr"></div>
          <form action="clloud" method="post" id="sendemail">
            <ol>
              <li>
                <label for="name">Name (required)</label>
                <input id="name" name="cloud" class="text" style="width:150px" />
              </li>
              <li>
