    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="TPA.jsp"><span>TPA</span></a></li>
      ...
      <div class="article" align="center">
          ...
          <br>
          <br>
          <h2 style="color: white"><span>THIRD PARTY AUDITOR</span></h2>
          <div class="clr"></div>
          <form action="TPA" method="post" id="sendemail">
            <ol>
              <li>
                <label for="name">Name (required)</label>
                <input id="name" name="tpa" class="text" style="width:150px" />
              </li>
              <li>
