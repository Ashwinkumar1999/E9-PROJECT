...
#customers th {
  ...
  color: white;
    ...
    <%
        ...
        %>
        <script>alert('Cloud login successful');</script>
        <%            }
        %>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li><a href="cloud_audit.jsp"><span>Send Proof</span></a></li>
          <li><a href="All_files.jsp"><span>Files In Cloud</span></a></li>
      ...
      <div class="clr"></div>
       <table id="customers">
                            ...
                            %>
                            <tr>
                                <td data-th="Movie Title"><%=rs.getString("uid")%></td>
                                <td data-th="Genre"><%=rs.getString("filekey")%></td>                     
                                <td data-th="Genre"><%=rs.getString("time")%></td>                     
                                <td><a href="audit_proof.jsp?fid=<%=rs.getString("filekey")%>&time=<%=rs.getString("time")%>&did=<%=rs.getString("uid")%>" style="color:seagreen ">Send Auditing Proof</a></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
