  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="article" align="center">
          ...
          <br>
          <br>
          <h2 style="color: white"><span>OTP Verification</span></h2>
          <div class="clr"></div>
          <form action="otp1.jsp" method="get" id="sendemail">
            <ol>
              <li>
                <label for="name">Enter Your OTP</label>
                <input id="name" name="votp" class="text" type="password" style="width:150px" />
              </li>
              <li>
                  <input style="color: #79acfa" type="submit" name="imageField" id="imageField" src="images/submit.gif" class="send" />
                <div class="clr"></div>
              </li>
            </ol>
          </form>
