...
<head>
<title>Fluffy Character Based Information Trustworthiness 
    Reviewing For Dependable Cloud Capacity Frameworks</title>
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="KGC.jsp"><span>KGC</span></a></li>
      ...
      <div class="article" align="center">
          ...
          <br>
          <br>
          <h2 style="color: white"><span>User Login</span></h2>
          <div class="clr"></div>
          <form action="user_login.jsp" method="get" id="sendemail">
            <ol>
              <li>
                <label for="name">Email</label>
                <input id="name" name="email" class="text" style="width:150px" />
              </li>
              <li>
                <label for="website">Password</label>
                <input id="website" type="password" name="pass" class="text" style="width:150px" />
              </li>
              <li>
                  <input style="color: #79acfa" type="image" name="imageField" id="imageField" src="images/submit.gif" class="send" />
                <div class="clr"></div>
              </li>
                <h2 style="color: white" > <a href="User_reg.jsp" >New User Registration</a></h2>
            </ol>
          </form>
        </div>
      </div>
