...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="index.jsp"><span>KGC Home Page</span></a></li>
          <li><a href="keyreq.jsp"><span>Key Request</span></a></li>
          <li><a href="kgc_users.jsp"><span>Users</span></a></li>
          <li><a href="kgc_users.jsp"><span>Users Id</span></a></li>
          <li><a href="index.jsp"><span>Logout</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
          <a href="#"><img src="images/kgc.jpg" width="960" height="400" alt="" /><span></span></a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
