...
#customers th {
  ...
  color: white;
    ...
    <%
        ...
        %>
        <script>alert('TPA login successful');</script>
        <%            }
        %>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
          <ul>
          <li><a href="TPA_audit_request.jsp"><span>Audit Request</span></a></li>
          <li><a href="cloud_req.jsp"><span>Request Cloud</span></a></li>
          <li><a href="proof_Check.jsp"><span>Proof Check</span></a></li>
    ...
    <table id="customers">
                    ...
                    <tr>
                        ...
                        <td><a href="send_cloud.jsp?uid=<%=rs.getString("uid")%>&fid=<%=rs.getString("filekey")%>" style="color:seagreen ">Send To Cloud</a></td>
                    </tr>
                     <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
